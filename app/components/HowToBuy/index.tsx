...
const HowToBuySection = () => {
    return (
        <div className='w-full h-full p-4 my-[50px] flex flex-col'>
            <span className="text-3xl md:text-5xl font-bold text-primary dark:text-text-dark font-Roboto px-4 ">How Ticket Port Works</span>
            <div className="flex flex-col w-full h-full items-center justify-center  mt-10 ">
                <div className="w-full h-full gap-6 md:w-6/2 flex flex-col md:flex-row justify-center md:justify-around items-center mt-10">
